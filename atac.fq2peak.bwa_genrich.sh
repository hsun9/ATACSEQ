...
echo 'Filter chrM ...'
$SAMTOOLS view -h ${PREFIX}.remDup.bam | grep -v chrM | $SAMTOOLS view -b -h -f 0x2  | $SAMTOOLS sort -m 4G -@ ${threads} -n -o ${PREFIX}.remDup.f2.nsort.bam -
$SAMTOOLS index ${PREFIX}.remDup.f2.nsort.bam


echo 'Call peak ...'
BAM=${PREFIX}.remDup.f2.nsort.bam
